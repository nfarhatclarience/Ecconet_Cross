...
/// Mark Latham made minor scoping modifications on 5/20/2017.
    ...
    internal sealed partial class WinUsbCommunications
    {
                                          ...
                                          UInt32 pipeTimeout)
        {
            try
            {
                ...
                if (success)
                {
                    Debug.WriteLine("USB-CAN: Have interface descriptors and pipe information.");
                    ...
                    for (var interfaceSetting = 0; interfaceSetting <= 1; interfaceSetting++)
                    {
                        ...
                        Debug.WriteLine("USB-CAN: Have interface {0} settings.", interfaceSetting);
                        ...
                        if (interfaceSetting == 1)
                        {
                            ...
                            if (success)
                                Debug.WriteLine("USB-CAN: Switched to interface 1 settings.");
                        }
                    }
                }
                return success;
        ...
        ///  <summary>
        ///  Sets pipe policy.  Mark Latham modified scope.
        ...
        ///  </returns>
        ///  
        internal Boolean SetPipePolicy(SafeWinUsbHandle winUsbHandle, Byte pipeId, UInt32 policyType, Byte value)
        {
            try
            {
                var success = false;
        ...
        ///  </returns>
        ///  
        internal Boolean SetPipePolicy(SafeWinUsbHandle winUsbHandle, Byte pipeId, UInt32 policyType, UInt32 value)
        {
            try
            {
                var success = false;
