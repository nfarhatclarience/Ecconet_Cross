...
<ExpressionCollection xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <Expressions>
    <Expression Name="Quad Flash SS 75 FPM" RegStandard="None" ExpressionEnum="3" Repeats="0" InputPriority="1" OutputPriority="1" Sequencer="0" Value="100">
      <Areas>
        <Area Name="Quad Flash SS 75 FPM Area 1" Key="500" DefaultValue="0">
          <Outputs>
            <Output Path="Red-531" Value="100" />
            <Output Path="Red-530" Value="100" />
            <Output Path="Red-529" Value="100" />
          </Outputs>
        </Area>
        <Area Name="Quad Flash SS 75 FPM Area 2" Key="501" DefaultValue="0">
          <Outputs>
            <Output Path="Blue-520" Value="100" />
            <Output Path="Blue-519" Value="100" />
            <Output Path="Blue-518" Value="100" />
          </Outputs>
        </Area>
      </Areas>
      <Entries>
    ...
    <Expression Name="Triple Pop 75 FPM" RegStandard="None" ExpressionEnum="4" Repeats="0" InputPriority="2" OutputPriority="1" Sequencer="0" Value="100">
      <Areas>
        <Area Name="Triple Pop 75 FPM Area 1" Key="500" DefaultValue="0">
          <Outputs>
            <Output Path="Red-530" Value="100" />
            <Output Path="Red-529" Value="100" />
            <Output Path="Red-514" Value="100" />
            <Output Path="Red-513" Value="100" />
            <Output Path="Blue-520" Value="100" />
            <Output Path="Blue-519" Value="100" />
            <Output Path="Blue-504" Value="100" />
            <Output Path="Blue-503" Value="100" />
          </Outputs>
        </Area>
      </Areas>
      <Entries>
    ...
    <Expression Name="Arrow 8 50" RegStandard="None" ExpressionEnum="6" Repeats="0" InputPriority="3" OutputPriority="1" Sequencer="3" Value="100">
      <Areas>
        <Area Name="Arrow 8 50 Area 1" Key="500" DefaultValue="0">
          <Outputs>
            <Output Path="Red-532" Value="100" />
          </Outputs>
        </Area>
        <Area Name="Arrow 8 50 Area 2" Key="501" DefaultValue="0">
          <Outputs>
            <Output Path="Red-515" Value="100" />
          </Outputs>
        </Area>
        ...
        <Area Name="Arrow 8 50 Area 7" Key="506" DefaultValue="0">
          <Outputs>
            <Output Path="Blue-502" Value="100" />
          </Outputs>
        </Area>
        <Area Name="Arrow 8 50 Area 8" Key="507" DefaultValue="0">
          <Outputs>
            <Output Path="Blue-517" Value="100" />
          </Outputs>
        </Area>
      </Areas>
      <Entries>
    ...
    <Expression Name="Arrow Right 8 B1-B8" RegStandard="None" ExpressionEnum="8" Repeats="0" InputPriority="4" OutputPriority="1" Sequencer="3" Value="100">
      <Areas>
    ...
    <Expression Name="Steady Override A1 &amp; B1" RegStandard="None" ExpressionEnum="10" Repeats="0" InputPriority="1" OutputPriority="5" Sequencer="0" Value="30">
      <Areas>
